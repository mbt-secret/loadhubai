...
function App() {
  ...
  return (
    <div className="app-stage">
      ...
      <section className="phone-shell" aria-label="TIRGo">
        <PhoneStatus />
        {error && (
  ...
  return (
    <div className="install-prompt" aria-label="Instaleaza aplicatia">
      ...
      <div className="install-prompt-copy">
        <strong>Instaleaza TIRGo</strong>
